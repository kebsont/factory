				  ...
				  <div class="contact-form">
				  	<h3>Contactez Nous!</h3>
					    <form method="post" action="contact-post.html">
					    	<div>
						    	<input name="userName" type="text" class="textbox textbox1" value="Prénom et Nom..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Prénom et Nom...';}" >
						    	<input name="userEmail" type="text" class="textbox" value="Email..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email...';}">
						    	<input name="usersubject" type="text" class="textbox" value="Objet..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Objet...';}">
						    	<div class="clear"></div>
						    </div>
						    <div>
						   ...
						   <div>
						   		<input type="submit" value="Envoyer"  class="mybutton">
						   		<div class="clear"></div>
						  </div>
					    </form>
				  </div>
